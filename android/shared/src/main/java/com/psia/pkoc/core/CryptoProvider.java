...
public class CryptoProvider
{
    ...
    /**
     * Helper to initialize credentials
     * @param activity Activity for preference savings
     */
    public static void initializeCredentials(Activity activity)
    {
    ...
    public static Key GetPublicKey ()
    {
        ...
        {
            Log.e(TAG, "Error getting public key from Android key store", e);
            return null;
        }
     ...
     * @param publicKey DER-encoded public key
     * @return Public key as [odd-or-even] | x
     */
    ...
    public static byte[] getAES256(byte[] secretKey, byte[] message, int counter)
    {
        try
        {
            ...
            Log.d(TAG, "Printing the secret key " + Hex.toHexString(secretKey));
            ...
            Log.d(TAG, "Encrypted data length: " + output.length);
            Log.d(TAG, "Encrypted data (hex): " + Hex.toHexString(output));

            return output;
        }
        catch (Exception e)
        {
            Log.e(TAG, "Error encrypting data in AES256", e);
            return null;
        }
    }
    ...
    public static byte[] getFromAES256(byte[] secretKey, byte[] message, int counter)
    {
        ...
        {
            Log.e(TAG, "Error decrypting message in AES256", e);
            return null;
        }
    }
    ...
    public static Key decodePublicKey(byte[] pubKey)
    {
        ...
        {
            Log.e(TAG, "Error decompressing public key", e);
            return null;
        }
    }
