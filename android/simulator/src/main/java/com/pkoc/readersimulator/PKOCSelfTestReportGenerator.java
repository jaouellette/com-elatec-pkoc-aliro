...
/**
 * Generates an HTML compliance report from PKOC self-test results.
 * Uses ELATEC brand colors and layout.
 */
public class PKOCSelfTestReportGenerator
{
    /**
                                  ...
                                  String deviceInfo, String appVersion)
    {
        ...
        sb.append("  <title>PKOC Compliance Report — ELATEC</title>\n");
        sb.append("  <style>\n");
        ...
        sb.append("    <h1>PKOC Compliance Report</h1>\n");
        sb.append("    <p>PSIA PKOC NFC v1.1 &amp; BLE v3.0.0 &middot; Generated: ").append(esc(date));
        ...
        sb.append("    Generated by ELATEC Open Credential Simulator App &middot; ");
        sb.append("PSIA PKOC NFC Card Specification v1.1 &middot; PSIA PKOC BLE Specification v3.0.0; LEAF Verified Specification v1.0\n");
        sb.append("  </div>\n");
        sb.append("</body>\n</html>");
